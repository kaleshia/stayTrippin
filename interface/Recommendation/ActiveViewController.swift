...
class ActiveViewController: UIViewController, UISearchBarDelegate {
    ...
    override func viewDidLoad() {
        ...
        activeTableView.register(UINib(nibName: "CustomCell", bundle: nil), forCellReuseIdentifier: "customCell")
        activeTableView.separatorStyle = .none
        
        retrieveVenues(latitude: CPLatitude, longitude: CPLongitude, category: "active",
