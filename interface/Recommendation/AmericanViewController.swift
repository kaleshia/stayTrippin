...
class AmericanViewController: UIViewController, UISearchBarDelegate {
    ...
    @IBOutlet weak var americanTableView: UITableView!
    ...
    override func viewDidLoad() {
        ...
        //Create custom cell
        americanTableView.delegate = self
        americanTableView.dataSource = self
        americanTableView.register(UINib(nibName: "CustomCell", bundle: nil), forCellReuseIdentifier: "customCell")
        americanTableView.separatorStyle = .none
                       ...
                       limit: 20, sortBy: "distance", locale: "en_US") { (response, error) in
                        ...
                        if let response = response {
                            ...
                            DispatchQueue.main.async {
                                self.americanTableView.reloadData()
                            }
                        }
        }
    }
    ...
    // Set information into custom cell
        extension AmericanViewController: UITableViewDelegate, UITableViewDataSource {
...
extension AmericanViewController {
