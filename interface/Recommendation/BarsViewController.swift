...
class BarsViewController: UIViewController, UISearchBarDelegate {
    ...
    override func viewDidLoad() {
        ...
        barsTableView.register(UINib(nibName: "CustomCell", bundle: nil), forCellReuseIdentifier: "customCell")
        barsTableView.separatorStyle = .none
        
        retrieveVenues(latitude: CPLatitude, longitude: CPLongitude, category: "bars",
