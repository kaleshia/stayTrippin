...
class AsianViewController: UIViewController, UISearchBarDelegate {
    ...
    override func viewDidLoad() {
        ...
        asianTableView.register(UINib(nibName: "CustomCell", bundle: nil), forCellReuseIdentifier: "customCell")
        asianTableView.separatorStyle = .none
                       ...
                       limit: 20, sortBy: "distance", locale: "en_US") { (response, error) in
                        ...
                        if let response = response {
                            ...
                            DispatchQueue.main.async {
                                self.asianTableView.reloadData()
                            }
                        }
        }
    }
    ...
    // Set information into custom cell
        extension AsianViewController: UITableViewDelegate, UITableViewDataSource {
...
///Users/kaleshia/Desktop/Senior Design/interface/interface/ToDoListViewController.swift
